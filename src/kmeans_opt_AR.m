...
if nargin > 1, ToTest = cell2mat(varargin(1));
else, ToTest = ceil(sqrt(m));
end
if nargin > 2, Cutoff = cell2mat(varargin(2));
else, Cutoff = 0.95;
end
if nargin > 3, Repeats = cell2mat(varargin(3));
else, Repeats = 3;
end
if nargin > 4, maxiter = cell2mat(varargin(4));
else, maxiter = 100;
end
if nargin > 5, parallel = varargin{5};
else, parallel = false;
end
if nargin > 6, kmin = cell2mat(varargin(6));
else, kmin = 1;
end
